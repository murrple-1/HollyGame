...
public class Cage extends AnimationActor {
	...
	private static class CheckCageDamage extends Action {
		...
		public boolean act(float delta) {
			...
			Collection<Enemy> damageEnemies = new ArrayList<>();
	...
	private static Animation<TextureRegion> cageAnimation = null;
	private static float cageAnimationWidth = Float.MIN_VALUE;
	private static float cageAnimationHeight = Float.MIN_VALUE;
	
	private static Animation<TextureRegion> createCageAnimation(MyGdxGame game) {
		if(cageAnimation == null) {
			...
			cageAnimation = new Animation<>(CAGE_FRAME_DURATION, new Array<>(frames), Animation.PlayMode.LOOP_PINGPONG);
		}

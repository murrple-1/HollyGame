...
public class Enemy extends AnimationActor {
	...
	private static Animation<TextureRegion> enemyAnimation = null;
	private static float enemyAnimationWidth = Float.MIN_VALUE;
	private static float enemyAnimationHeight = Float.MIN_VALUE;
	
	private static Animation<TextureRegion> createEnemyAnimation(MyGdxGame game) {
		if(enemyAnimation == null) {
			...
			enemyAnimation = new Animation<>(ENEMY_FRAME_DURATION, new Array<>(frames), Animation.PlayMode.LOOP_PINGPONG);
		}
